    ...
    switch (type) {
        ...
        case 'AvailabilityCalendar':
            return {
                ...
                case 'Stats':
            return { id, type, variant: 'A', data: { items: [{ value: '2,400+', label: 'Clientes activos' }, { value: '98%', label: 'Satisfacción' }, { value: '40h', label: 'Ahorradas/mes' }, { value: '< 2min', label: 'Setup inicial' }] }, styles: commonStyles };
        case 'Team':
            return { id, type, variant: 'A', data: { title: 'Nuestro equipo', members: [{ name: 'María García', role: 'CEO & Fundadora', bio: 'Líder con 15 años de experiencia.', avatar: 'https://i.pravatar.cc/200?img=47' }, { name: 'Carlos Ruiz', role: 'CTO', bio: 'Apasionado por los productos.', avatar: 'https://i.pravatar.cc/200?img=53' }] }, styles: commonStyles };
        case 'LogoCloud':
            return { id, type, variant: 'A', data: { title: 'Confían en nosotros', logos: ['Airbnb', 'Spotify', 'Notion', 'Figma', 'Linear'] }, styles: commonStyles };
        case 'NewsletterSignup':
            return { id, type, variant: 'A', data: { title: '¡Suscríbete!', subtitle: 'Las últimas novedades directas a tu bandeja.', ctaLabel: 'Suscribirme', placeholder: 'tu@email.com' }, styles: commonStyles };
                default:
            return {
                id, type, variant: 'A',
